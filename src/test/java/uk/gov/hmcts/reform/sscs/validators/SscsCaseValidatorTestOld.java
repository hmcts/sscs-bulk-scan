...
public class SscsCaseValidatorTestOld {
    ...
    public void givenAnAppellantIsEmpty_thenAddAWarning() {
        ...
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, pairs);
    ...
    public void givenAnAppealDoesNotContainAnMrnDate_thenAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithMrn(MrnDetails.builder().dwpIssuingOffice("2").build(), buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAnMrnDateInFuture_thenAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithMrn(MrnDetails.builder().dwpIssuingOffice("2").mrnDate("2148-10-10").build(), buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAHearingExcludedDateInPast_thenAddAWarning() {
        ...
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithExcludedDate("2018-10-10", appellant, true));
    ...
    public void givenAnAppealDoesNotContainABenefitTypeDescription_thenAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType(null, buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAnInvalidBenefitTypeDescription_thenAddAnError() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType("Bla", buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAValidLowercaseBenefitTypeDescription_thenDoNotAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType(PIP.name().toLowerCase(), buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAValidBenefitTypeDescription_thenDoNotAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType(PIP.name(), buildAppellant(false), true));
    ...
    public void givenAnAppealContainsAnInvalidAppellantMobileNumberLessThan10Digits_thenAddAnError() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType("Bla", buildAppellantWithMobileNumber("07776156"), true));
    ...
    public void givenAnAppealContainsAnInvalidRepresentativeMobileNumberLessThan10Digits_thenAddAnError() {
        ...
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithRepresentative(buildAppellant(false), representative, true));
    ...
    public void givenAnAppealContainsValidAppellantAnInvalidAppointeeMobileNumberLessThan10Digits_thenAddAnError() {
        ...
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType("Bla", appellant, true));
    ...
    public void givenAnAppealContainsAnInvalidAppellantMobileNumberGreaterThan11Digits_thenAddAnError() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType("Bla", buildAppellantWithMobileNumber("077761560000"), true));
    ...
    public void givenAnAppealContainsAValidAppellantMobileNumber_thenDoNotAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType(PIP.name(), buildAppellantWithMobileNumber(VALID_MOBILE), true));
    ...
    public void givenAnAppealContainsAValidPostcode_thenDoNotAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithBenefitType(PIP.name(), buildAppellantWithPostcode(VALID_POSTCODE), true));
    ...
    public void givenAnAppealWithNoHearingType_thenAddAWarning() {
        CaseResponse response = validator.validateExceptionRecordOld(transformErrorResponse, caseDetails, buildMinimumAppealDataWithHearingType(null, buildAppellant(false), true));
