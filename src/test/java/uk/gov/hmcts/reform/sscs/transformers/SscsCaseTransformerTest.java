...
import static uk.gov.hmcts.reform.sscs.config.SscsConstants.IS_BENEFIT_TYPE_TAX_CREDIT;
...
public class SscsCaseTransformerTest {
    ...
    private Appeal buildTestAppealData() {
        ...
        return Appeal.builder()
            ...
            .appellant(appellant)
            .appealReasons(AppealReasons.builder().reasons(singletonList(AppealReason.builder().value(AppealReasonDetails.builder().description(APPEAL_REASON).build()).build())).build())
