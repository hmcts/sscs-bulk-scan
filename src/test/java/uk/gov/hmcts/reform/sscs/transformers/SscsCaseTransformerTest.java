...
public class SscsCaseTransformerTest {
    ...
    public void setup() {
        ...
        transformer = new SscsCaseTransformer(sscsJsonExtractor, keyValuePairValidator, sscsDataHelper, fuzzyMatcherService, dwpAddressLookupService, idamService, ccdService, false, false);
