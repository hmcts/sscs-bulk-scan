...
public class TransformationFunctionalTest extends BaseFunctionalTest {
    ...
    @Test
    public void transform_appeal_created_case_and_populate_postcode_related_fields_from_appellant() throws IOException {
        String json = getJson("exception/all_fields_entered_only_appellant.json");
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(caseData.get("region")).isEqualTo("CARDIFF");
            Map<String, Object> regionalProcessingCenter = (Map<String, Object>) caseData.get("regionalProcessingCenter");
            softly.assertThat(regionalProcessingCenter.get("name")).isEqualTo("CARDIFF");
            softly.assertThat(regionalProcessingCenter.get("city")).isEqualTo("CARDIFF");
            softly.assertThat(regionalProcessingCenter.get("email")).isEqualTo("Cardiff_SYA_Respon@justice.gov.uk");
            softly.assertThat(regionalProcessingCenter.get("postcode")).isEqualTo("CF24 0AB");
            softly.assertThat(regionalProcessingCenter.get("phoneNumber")).isEqualTo("0300 123 1142");

            softly.assertThat(caseData.get("processingVenue")).isEqualTo("Cardiff");
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void transform_appeal_created_case_and_populate_postcode_related_fields_from_appellant_and_appointee() throws IOException {
        String json = getJson("exception/all_fields_entered_appellant_and_appointee.json");
        Response response = transformExceptionRequest(json, OK.value());
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(caseData.get("region")).isEqualTo("SUTTON");
            Map<String, Object> regionalProcessingCenter = (Map<String, Object>) caseData.get("regionalProcessingCenter");
            softly.assertThat(regionalProcessingCenter.get("name")).isEqualTo("SUTTON");
            softly.assertThat(regionalProcessingCenter.get("city")).isEqualTo("SUTTON");
            softly.assertThat(regionalProcessingCenter.get("email")).isEqualTo("Sutton_SYA_Respons@justice.gov.uk");
            softly.assertThat(regionalProcessingCenter.get("postcode")).isEqualTo("SM1 1DA");
            softly.assertThat(regionalProcessingCenter.get("phoneNumber")).isEqualTo("0300 123 1142");
