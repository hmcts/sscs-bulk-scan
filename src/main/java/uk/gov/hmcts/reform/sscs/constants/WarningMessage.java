...
public enum WarningMessage {
    ...
    APPELLANT_ADDRESS_LINE3(ADDRESS_LINE3, "Appellant address county"),
    APPOINTEE_ADDRESS_LINE3(ADDRESS_LINE3, "Appointee address county"),
    REPRESENTATIVE_ADDRESS_LINE3(ADDRESS_LINE3, "Representative address county"),
