...
public enum WarningMessage {
    ...
    APPELLANT_ADDRESS_LINE3_COUNTY(ADDRESS_LINE3_COUNTY, "Appellant address county"),
    APPOINTEE_ADDRESS_LINE3_COUNTY(ADDRESS_LINE3_COUNTY, "Appointee address county"),
    REPRESENTATIVE_ADDRESS_LINE3_COUNTY(ADDRESS_LINE3_COUNTY, "Representative address county"),
