...
public enum WarningMessage {
    ...
    HEARING_TELEPHONE_NUMBER_MULTIPLE("Telephone hearing selected but the number used is invalid. Please check either the hearing_telephone_number, person1_mobile or person1_phone fields", "Telephone hearing selected but the number used is invalid. Please check either the mobile, telephone or hearing telephone number fields");
